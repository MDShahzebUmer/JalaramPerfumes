    ...
    <div class="side-bar-manu">
        <ul>
            @if(auth()->user()->can('browse_dashboard') || auth()->user()->hasRole('super-admin'))
                <li>
                    <a class="@if(Request::is('/admin'))active @endif"
        ...
        <!--end orders -->
            ...
            @if(Module::has('ProductManagement') && Module::find('ProductManagement')->isEnabled())
                @if(auth()->user()->can('browse_product_management') || auth()->user()->hasRole('super-admin'))
                    <li class="@if(Request::is('admin/products', 'admin/products/*','admin/categories','admin/categories/*','admin/brands','admin/brands/*')) active  @endif">
                        <a href="#">
                    <span class="icon">
            ...
            @if(auth()->user()->can('browse_faq_manager') || auth()->user()->hasRole('super-admin'))
                <li class="@if(Request::is('admin/faq_category','admin/faq_category/*','admin/faq_subcategory','admin/faq_subcategory/*','admin/faq_content','admin/faq_content/*')) active  @endif">
                    <a href="#"><span class="icon"><svg viewBox="0 0 22 23" xmlns="http://www.w3.org/2000/svg"><g
                                                        clip-path="url(#clip0)"><path
                                                            d="M22.0006 15.1383C22.0006 12.4082 20.4344 9.97179 18.0887 8.78662C18.0159 14.0211 13.7721 18.2649 8.5376 18.3378C9.72276 20.6834 12.1592 22.2496 14.8893 22.2496C16.1692 22.2496 17.414 21.9087 18.5077 21.261L21.9695 22.2186L21.012 18.7567C21.6597 17.663 22.0006 16.4183 22.0006 15.1383Z"/><path
                                                            d="M16.8008 8.65039C16.8008 4.01833 13.0325 0.25 8.40039 0.25C3.76833 0.25 0 4.01833 0 8.65039C0 10.16 0.401825 11.6298 1.16486 12.9202L0.0308838 17.0197L4.13054 15.8859C5.42094 16.649 6.89078 17.0508 8.40039 17.0508C13.0325 17.0508 16.8008 13.2825 16.8008 8.65039ZM7.11133 6.69531H5.82227C5.82227 5.27365 6.97873 4.11719 8.40039 4.11719C9.82205 4.11719 10.9785 5.27365 10.9785 6.69531C10.9785 7.41689 10.673 8.11043 10.1401 8.59785L9.04492 9.60023V10.6055H7.75586V9.03258L9.26984 7.64684C9.54041 7.39926 9.68945 7.06139 9.68945 6.69531C9.68945 5.98448 9.11122 5.40625 8.40039 5.40625C7.68956 5.40625 7.11133 5.98448 7.11133 6.69531ZM7.75586 11.8945H9.04492V13.1836H7.75586V11.8945Z"/></g></svg>
                          </span>
            ...
            @if(auth()->user()->can('browse_user_permission') || auth()->user()->hasRole('super-admin'))
                    <li class="@if(Request::is('admin/permissions','admin/permissions/*','admin/users','admin/users/*','admin/roles','admin/roles/*')) active  @endif">
                        <a href="#"><span class="icon"><svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><g
                                        clip-path="url(#clip0)"><path
                                            d="M18.5417 13.763H18.3333V12.513C18.3333 11.3647 17.3984 10.4297 16.25 10.4297C15.1016 10.4297 14.1667 11.3647 14.1667 12.513V13.763H13.9583C13.1541 13.763 12.5 14.4171 12.5 15.2214V18.138C12.5 18.9423 13.1541 19.5964 13.9583 19.5964H18.5417C19.3459 19.5964 20 18.9423 20 18.138V15.2214C20 14.4171 19.3459 13.763 18.5417 13.763ZM15.4167 12.513C15.4167 12.0538 15.7909 11.6797 16.25 11.6797C16.7091 11.6797 17.0833 12.0538 17.0833 12.513V13.763H15.4167V12.513Z"/><path
                                            d="M11.25 15.2214C11.25 14.0964 11.9392 13.1305 12.9167 12.7214V12.513C12.9167 12.0064 13.0391 11.5314 13.2425 11.1005C12.6125 10.6779 11.8558 10.4297 11.0417 10.4297H3.95828C1.77582 10.4297 0 12.2055 0 14.388V17.3047C0 17.6497 0.279999 17.9297 0.625 17.9297H11.25V15.2214Z"/><path
                                            d="M11.6664 4.59641C11.6664 6.89758 9.8009 8.76297 7.49973 8.76297C5.19855 8.76297 3.33301 6.89758 3.33301 4.59641C3.33301 2.29523 5.19855 0.429688 7.49973 0.429688C9.8009 0.429688 11.6664 2.29523 11.6664 4.59641Z"/></g></svg></span>
